    ...
    <Layout>
      ...
      >
        <div className="space-y-8 max-w-[1600px] mx-auto">
          ...
          {/* Tab Navigation */}
          <div className="sticky top-0 z-[100] flex bg-white/90 backdrop-blur-md px-2 py-2 rounded-xl border border-slate-200 shadow-sm overflow-x-auto scrollbar-none gap-0.5">
            {projectTabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-semibold transition-all whitespace-nowrap shrink-0 ${isActive ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-100'}`}
                >
